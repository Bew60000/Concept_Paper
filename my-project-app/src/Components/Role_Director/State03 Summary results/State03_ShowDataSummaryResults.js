...
import State03_ModalDetailForm from './State03_ModalDetailForm';
import State03_ModalAsSummaryResults from './State03_ModalAsSummaryResults';
import Navbar from '../../Navbar/NavbarDirector';
import NavbarDirectorFunctions from '../../Navbar/NavbarDirectorFunctions';

const State03_ShowDataSummaryResults = () => {
    ...
    useEffect(() => {
        const fetchForms = async () => {
            try {
                ...
                const awaitingForms = response.data.filter(form => form.status_evaluate === 'ประเมินผลเสร็จสิ้น' && form.evaluator_position === 'หัวหน้าคณะกรรมการ');
                                ...
                                return (
                                    <div key={index} className="bg-gray-200 hover:bg-gray-100 p-6 rounded-xl w-full mb-4">
                                        <div className="grid grid-cols-12 gap-4 items-center">
                                            ...
                                            <div className="col-span-2 text-center">
                                                <p className="text-blue-600 font-bold">"รอการสรุปผล"</p>
                                            </div>
                                        </div>
...
export default State03_ShowDataSummaryResults;
