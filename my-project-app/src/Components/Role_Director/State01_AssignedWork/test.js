...
const State01_Assignedwork = ({ isOpen, closeModal, selectedForm, studentData, teacherData, UpdateStatus }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-white p-6 rounded-lg w-12/12 rounded-full max-h-[650px] overflow-y-auto mt-16">
        {selectedForm && (
          <div className='text-gray-700'>
            ...
            <Form >
              ...
              <FormGroup className="flex items-center space-x-4 p-12 pb-0">
              ...
              <FormTextArea className="p-12  pt-0"
                fluid
