...
import ModalDetailForm from './State06_ModalDetailForm';

function State06_ShowDetailCanceled_request() {
                    ...
                    <div className="bg-white border-2 rounded-2xl p-10" style={{ minHeight: '930px' }}>
                        ...
                        <div className="grid grid-cols-12 gap-4 items-center mb-3 bg-gray-700 rounded-xl text-gray-100 p-6 py-5">
                            <div className="col-span-2 text-center">
                                <p className="text-lg font-bold m-1 text-center">วันที่ยกเลิก</p>
                            </div>
...
export default State06_ShowDetailCanceled_request;
