...
const State02_Assign_work = ({ isOpen, closeModal, selectedForm, studentData, teacherData, UpdateStatus }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center">
      <div className="bg-white p-12 rounded-lg w-11/12 rounded-full min-h-[650px] max-h-[650px] overflow-y-auto mt-16">
        {selectedForm && (
          <div className='text-gray-700 px-12'>
            ...
            <div className="grid grid-cols-12 gab-1 items-center ">
              <div className="col-span-12 text-start p-5">
                <h2 className="font-bold m-0 mb-2 text-blue-900"> การเลือกคณะกรรมการประเมินผล</h2>
              </div>
            </div>
            ...
            <div className='mx-12'>
              <div className="bg-gray-200 hover:bg-gray-100 p-6 rounded-xl w-full mb-4">
        ...
        <div className='mx-12 text-gray-700'>
          ...
          <div className="grid grid-cols-12 gab-1 items-center ">
            <div className="col-span-12 text-start p-5">
              <h2 className="font-bold m-0 mb-2 text-blue-900"> รายชื่อคณะกรรมการ</h2>
            </div>
          </div>

          {currentItems.map((user, index) => (
            <div key={index} className='mx-12'>
              <div className="bg-gray-100 p-3 rounded-xl w-full mb-4">
                <div className="grid grid-cols-12 gap-4 items-center">
                  <div className="col-span-3 text-start">
                    <p className="text-gray-800 text-center font-bold m-0">{indexOfFirstItem + index + 1}.{user.name}&nbsp;{user.lastname}</p>
                  </div>
                  <div className="col-span-2 text-start">
                    <p className="text-gray-500">วิทยาเขต: {user.campus}</p>
                  </div>
                  <div className="col-span-3 text-start">
