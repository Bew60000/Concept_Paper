...
const State02_Assign_work = ({ isOpen, closeModal, selectedForm, studentData, teacherData, UpdateStatus }) => {
  ...
  const [selectedRoles, setSelectedRoles] = useState({}); // เก็บค่าที่เลือกสำหรับแต่ละบุคคล
                ...
                <div className="bg-gray-100 hover:bg-gray-200 p-3 rounded-xl w-full mb-2">
                  <div className="grid grid-cols-12 gap-4 items-center">
                    <div className="col-span-3 col-start-1 ml-12 mr-2 text-start">
                      <p className="text-gray-800 font-bold m-0">{indexOfFirstItem + index + 1}. {director.name}&nbsp;{director.lastname}</p>
                    </div>
                    <div className="col-span-2 text-start">
                      <p className="text-gray-500"><strong>วิทยาเขต :</strong> {director.campus}</p>
                    </div>
                    <div className="col-span-3 text-start">
                    ...
                    <div className="col-span-4 text-start">
                      <label>
                        <input
                          ...
                          onChange={() => handleRoleChange(director.id, 'หัวหน้าคณะกรรมการ')}
                        />
                        หัวหน้าคณะกรรมการ
                      </label>
                      ...
                      <label className="ml-4">
                        <input
                          ...
                          onChange={() => handleRoleChange(director.id, 'คณะกรรมการ')}
                        />
                        คณะกรรมการ
                      </label>
                    </div>
