...
import State05_ModalDetailAssessment from '../../../Role_Director/State04 Completed Summary results/State04_ModalDetailSummaryResults';
import State05_ModalDetailForm from './State05_ModalDetailForm';
                                    ...
                                    <div key={index} className="bg-gray-200 hover:bg-gray-100 p-6 rounded-xl w-full mb-4">
                                        ...
                                        <div className="flex justify-end items-center mt-2">
                                            ...
                                            <button onClick={() => openAssessment(info)}
                                                className="bg-sky-500 hover:bg-sky-700 hover:font-bold text-white px-4 py-2 rounded-lg ml-2">
                                                <div className="flex justify-start items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6 mr-2">
