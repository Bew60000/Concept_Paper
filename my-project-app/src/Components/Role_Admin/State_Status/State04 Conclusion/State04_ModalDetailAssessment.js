...
const State04_ModalDetailAssessment = ({ isOpen, closeModal, selectedForm, studentData, teacherData, UpdateStatus, scoreData }) => {
                            ...
                            <div className="bg-gray-100 p-6 rounded-xl w-full mb-4">
                                <div className="grid grid-cols-12 gap-4 items-center">
                                    ...
                                    <div className="col-span-4 text-start">
                                        ...
                                        <p className='text-gray-500 m-0'>{selectedForm.total_score}</p>
                                    </div>
...
export default State04_ModalDetailAssessment;
