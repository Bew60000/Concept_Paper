...
import State04_ModalDetailAssessment from '../../../Role_Director/State04 Completed Summary results/State04_ModalDetailSummaryResults';
                                    ...
                                    <div key={index} className="bg-gray-200 hover:bg-gray-100 p-6 rounded-xl w-full mb-4">
                                        ...
                                        <div className="flex justify-end items-center mt-2">
                                            ...
                                            <button onClick={() => openModal(info)}
                                                className="bg-gray-500 hover:bg-gray-700 hover:font-bold text-white px-4 py-2 rounded-lg ml-2">
                                                <div className="flex justify-start items-center">
