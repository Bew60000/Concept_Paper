...
function IsModal({ isOpen, closeModal, selectedForm, findUserByUsername }) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div ref={modalRef} className="bg-white p-6 rounded-lg w-7/12 rounded-full max-h-[650px] overflow-y-auto mt-16">
                <div className='text-gray-700'>
                    ...
                    <div className="pr-5 pl-5">
                        <p className="m-1"><strong>จำนวนปีที่เปิดหลักสูตร:</strong> {selectedForm.year_opened}</p>
                        <p className="m-1"><strong>จำนวนผู้เรียนในหลักสูตร:</strong> {selectedForm.count_students}</p>
                    </div>
